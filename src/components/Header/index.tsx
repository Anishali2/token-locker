...
export default function Header() {
  ...
  console.log('redux', { address, isConnected, chain });
              ...
              <div className="flex items-center">
                ...
                {address && isConnected && chain?.id == 5 ? (
                  <>
                    ...
                    <ToolTip tooltip="Disconnect" cursor>
                      <div
                        onClick={() => disconnect()}
                        className="relative hover:bg-slate-100 inline-flex items-center px-4 py-2 border border-[#8080806e] shadow-sm text-sm font-medium rounded-md text-white "
                      >
                        <svg
                          stroke="black"
                          fill="black"
